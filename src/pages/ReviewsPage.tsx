  ...
  const staticReviews: LocalReview[] = [
    {
      ...
      name: 'James Carter',
      rating: 5,
      message: 'Absolutely blown away by the quality of work. QuadCode delivered a world-class platform that exceeded every expectation.',
    ...
    },
    {
      ...
      name: 'Marcus Hoffman',
      rating: 5,
      message: 'QuadCode turned our complex requirements into an elegant solution. Their backend architecture is rock-solid and highly scalable.',
